export default {
  route: {
    ...
    incidentInvestigation: '事件调查',
    voluntaryReport: '自愿报告',
    mandatoryReport: '强制报告',
    dangerManagerment: '风险管理',
    modelDesign: '模型设计',
    riskAssessmentDataExport: '风险评价数据输出',
    safetyRiskPrompt: '安全风险提示',
    riskAssessmentProcess: '风险评价流程',
    dangerEvaluate: '风险评价',
    ...
    safetyHazardControlList: '安全隐患管控清单',
    safetyHazardsStatistics: '安全隐患统计',
    safetyHazardsFollow: '重大安全隐患跟踪',
