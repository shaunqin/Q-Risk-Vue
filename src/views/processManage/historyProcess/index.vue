<template>
  <div class="app-container">
    ...
    />
    <edetail ref="edetail" :showOperation="false" />
  </div>
</template>
...
import edetail from '@/views/processManage/hasIssue/detail'
export default {
  components: { edetail },
  mixins: [initData],
  data() {
  ...
  methods: {
    format,
    beforeInit() {
      this.url = `/process_mgr/query/pageListHistory/${this.page}/${this.size}`;
